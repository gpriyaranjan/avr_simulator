...
public:
    ...
    static bool RJMP(Environ& env, uint16_t instrn);
    static bool RJMP(Environ& env, TwelveBit tgtOffset, bool dummy);

    static bool JMP(Environ& env, uint32_t instrn);
    ...
    static bool PUSH(Environ& env, uint16_t instrn);
    static bool PUSH(Environ& env, FiveBit regAddr, bool dummy);

    static bool POP(Environ& env, uint16_t instrn);
    static bool POP(Environ& env, FiveBit regAddr, bool dummy);

    static bool RCALL(Environ& env, uint16_t instrn);
    static bool RCALL(Environ& env, TwelveBit tgtOffset, bool dummy);

    static bool CALL(Environ& env, uint32_t instrn);
